...
"""
"""
M9: SwiGLU Ψ-NN Pile Stiffness Degradation - Web Application
=============================================================
Shows SwiGLU Ψ-model predictions alongside structure discovery:
    - Prototype clustering, learned relation matrix, compression stats
    - Comparison with M6 teacher
    - Per-slot, per-variable accuracy metrics
"""
...
HTML = '''<!DOCTYPE html><html><head><title>M9 SwiGLU Ψ-NN Pile Stiffness</title>
...
<div class="container">
<h1>M9: SwiGLU &Psi;-NN Pile Stiffness Degradation</h1>
<p class="subtitle">SwiGLU Slot MLP, Learnable R, Physics Loss &nbsp;|&nbsp; <a href="/diagnosis" style="color:#ffa500;text-decoration:underline">Worst-Scenario Diagnosis &rarr;</a></p>
...
if __name__ == '__main__':
    print("=" * 50)
    print("M9: SwiGLU Psi-NN Pile Stiffness Degradation")
    print("=" * 50)
    if load_all():
